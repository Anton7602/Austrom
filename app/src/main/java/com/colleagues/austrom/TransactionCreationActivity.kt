...
class TransactionCreationActivity : AppCompatActivity(), IDialogInitiator {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        categorySelector.setOnClickListener {
            ...
            CategorySelectionDialogFragment(transactionType, this).show(supportFragmentManager, "CategorySelectionDialog")
        }
    ...
    override fun receiveValue(value: String, valueType: String) {
        if (valueType=="CategoryId") {
            this.selectedCategory = when (transactionType) {
                TransactionType.EXPENSE -> AustromApplication.activeExpenseCategories[value] ?: AustromApplication.activeExpenseCategories.values.first()
                TransactionType.INCOME -> AustromApplication.activeIncomeCategories[value] ?: AustromApplication.activeIncomeCategories.values.first()

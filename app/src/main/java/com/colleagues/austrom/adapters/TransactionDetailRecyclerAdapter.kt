...
//        val currency: TextView = itemView.findViewById(R.id.trdetit_currency_txt)
    ...
    override fun onBindViewHolder(holder: TransactionDetailViewHolder, position: Int) {
       ...
       // holder.costField.setValue(transactionDetail.cost, AustromApplication.activeCurrencies[transaction.assetId]?.symbol ?: throw InvalidTransactionException(TransactionValidationType.UNKNOWN_ASSET_INVALID))
        holder.costField.setValue(transactionDetail.cost)

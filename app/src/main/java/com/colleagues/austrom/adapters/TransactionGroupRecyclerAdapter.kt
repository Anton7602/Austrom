...
class TransactionGroupRecyclerAdapter(private val groupedTransactions: MutableMap<LocalDate, MutableList<Transaction>>, private val activity: AppCompatActivity) : RecyclerView.Adapter<TransactionGroupRecyclerAdapter.TransactionGroupViewHolder>(){
    ...
    override fun onBindViewHolder(holder: TransactionGroupViewHolder, position: Int) {
        ...
        val adapter = TransactionRecyclerAdapter(groupedTransactions.values.elementAt(position), activity)

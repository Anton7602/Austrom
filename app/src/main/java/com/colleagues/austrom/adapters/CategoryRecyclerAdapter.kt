...
class CategoryRecyclerAdapter(private val categories: MutableList<Category>,
                              ...
                              private val isEditCategoryAllowed: Boolean = false,
                              private val receiver: IDialogInitiator? = null): RecyclerView.Adapter<CategoryRecyclerAdapter.CategoryNewViewHolder>()  {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryNewViewHolder {
        return CategoryNewViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_category, parent, false))
    }
    ...
    override fun onBindViewHolder(holder: CategoryNewViewHolder, position: Int) {
        ...
        if (isEditCategoryAllowed) {
            ...
            receiver?.receiveValue(category.categoryId, "CategoryId")
        }
    }
}